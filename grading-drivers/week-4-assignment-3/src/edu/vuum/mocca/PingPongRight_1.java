...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        SimpleSemaphore mFirstSema;
        SimpleSemaphore mSecondSema;
        ...
        public PlayPingPongThread(String stringToPrint,
            ...
            // TODO - You fill in here.
        	mText = stringToPrint;
        	mFirstSema = semaphoreOne;
        	mSecondSema = semaphoreTwo;
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread(/*
                                                          ...
                                                          * here
                                                          */
        		"a", pingSema, pongSema, maxIterations);
        PlayPingPongThread pong = new PlayPingPongThread(/*
                                                          * TODO - You fill in
                                                          * here
                                                          */
        		"b", pongSema, pingSema, maxIterations);
