...
public class LoginActivity extends StoryActivityBase{
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48
				...
				"login.txt");
		/*
		 * Otherwise I would completely re-factor this method and 
		 * StorageUtilities. Since we are asked to modify only this file,
		 * I decided to implement the simplest fix. Just gave the right
		 * security privileges to method call.
		 */
	}
