...
public class LoginActivity extends StoryActivityBase{
	...
	static final int MAX_SECURITY = StorageUtilities.SECURITY_PRIVATE;  // Changed to specific security mode, not Integer.MAX_VALUE
	...
	public static File getLoginFile (Context context) {
		return StorageUtilities.getOutputMediaFile(context, 	// Line 48 TODO: SECURITY
