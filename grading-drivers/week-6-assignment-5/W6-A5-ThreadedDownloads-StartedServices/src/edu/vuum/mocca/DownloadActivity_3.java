...
public class DownloadActivity extends DownloadBase {
    ...
    static class MessengerHandler extends Handler {
		...
		public void handleMessage(Message msg) {
            ...
            if (activity != null) {
            	...
            	outerClass.get().displayBitmap(msg.getData().getString(DownloadUtils.PATHNAME_KEY));
            }
    	}
    }
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	this.startService(DownloadIntentService.makeIntent(getApplicationContext(), handler, this.getUrlString()));
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	this.startService(ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, this.getUrlString()));
